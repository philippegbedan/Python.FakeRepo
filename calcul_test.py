...
class TestCalcul(unittest.TestCase):
    ...
    def test_ajouter_puis_multiplier(self):
        self.assertEqual(ajouter_puis_multiplier(1,2,3),9)      # (1+2)*3 = 9
        self.assertEqual(ajouter_puis_multiplier(2,3,4),20)     # (2+3)*4 = 20
        self.assertEqual(ajouter_puis_multiplier(0,5,2),10)     # (0+5)*2 = 10
